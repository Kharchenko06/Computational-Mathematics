...
int main() {
    ...
    const std::vector<TestCase> cases = {
        ...
        { {1e15, 1e15, 1e15}, {1e15+1.0, 1e15+1.0, 1e15+1.0}, "R3: потеря бит, diff=sqrt(3)" },
        { {1e8, 2e8, 3e8}, {1e8+3.0, 2e8+4.0, 3e8+0.0},       "R3: потеря бит, diff=5" },
        ...
        // R^n с катастрофической потерей значащих бит
        { {1e15,1e15,1e15,1e15,1e15},
          {1e15+1,1e15+1,1e15+1,1e15+1,1e15+1}, "R5: потеря бит, diff=sqrt(5)" },
    };
