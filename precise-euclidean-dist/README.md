...
# CLI-демо (3-4-5 и катастрофическая отмена)
make demo
...
- Катастрофическая отмена: `A = (1e15,…)`, `B = (1e15+1,…)`, ожидается `sum = 3.0`
...
### `test_euclidean_full`
- 16 пар точек: `R^2`, `R^3`, `R^5`, катастрофическая отмена, экстремальные значения
